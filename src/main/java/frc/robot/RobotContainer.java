...
public class RobotContainer {
  ...
  private static final Camera frontCamera = new Camera("pineapple", new Transform3d(new Translation3d(0.254, 0, 0.1524), new Rotation3d(Math.PI, -0.785, 0)));
  private static final Camera backCamera = new Camera("dragonfruit", new Transform3d(new Translation3d(-0.254, 0, 0.1524), new Rotation3d(0, -0.785, 0)));
  ...
  private void configureBindings() {
    ...
    Command goToLocation = new goToLocation(drivebase, new Pose2d(1.3, 1.1, new Rotation2d()));
    Command stop = new stop(goToLocation);
    JoystickButton button_a = new JoystickButton(driveStick, 1);
    button_a.onTrue(goToLocation).onFalse(stop);
  }
